<template>
    <el-main>
        ...
        <el-row v-if="$route.query.transitionType == 'signout'">
            <span class="name">{{ $route.query.name }}</span><span class="blueFont"> sign out success</span>
            <h1>Please return your visitor pass to reception</h1>
        </el-row>
        <el-row v-if="$route.query.transitionType == 'signin'">
            <span class="name">{{ $route.query.name }}</span><span class="blueFont"> sign in success</span>
